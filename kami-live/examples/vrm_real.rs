...
async fn run() {
    ...
    println!(
        "VRM: {} meshes, {} nodes, {} materials",
        doc.gltf.meshes.len(),
        doc.gltf.nodes.len(),
        doc.gltf.materials.len()
    );
    ...
    let vp = Mat4::perspective_rh(0.7, w as f32 / h as f32, 0.05, 100.0)
