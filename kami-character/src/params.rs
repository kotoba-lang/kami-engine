...
pub enum HairPreset {
    ShortStraight, ShortWavy, ShortCurly,
    MediumStraight, MediumWavy, MediumLayered,
    LongStraight, LongWavy, LongCurly,
    PonytailHigh, PonytailLow, BunTop, BunLow,
    Bob, Pixie, Buzz, Undercut, Mohawk,
    AfroShort, AfroLarge,
    BraidsTwin, BraidsSingle,
    Bald,
}
...
pub enum ClothingPreset {
    TankTop, TShirt, Blouse, Hoodie, Jacket,
    DressCasual, DressFormal,
    SuitCasual, SuitFormal,
    UniformSchool, UniformMilitary,
    NudeShoulders,
}
    ...
    fn default() -> Self {
        Self {
            face: FaceShapeParams {
                jaw_width: 0.4, jaw_length: 0.5, chin_shape: 0.3,
                cheekbone_width: 0.55, cheekbone_height: 0.6,
                forehead_height: 0.5, forehead_width: 0.5,
                temple_width: 0.5, face_length: 0.6,
            },
            eyes: EyeParams {
                size: 0.7, width: 0.6, height: 0.55, spacing: 0.5,
                tilt: 0.1, depth: 0.5, iris_size: 0.8,
                iris_color: [0.45, 0.65, 0.85],
            },
            nose: NoseParams {
                length: 0.4, width: 0.35, bridge_height: 0.45,
                tip_shape: 0.6, tip_angle: 0.55, nostril_width: 0.35,
            },
            mouth: MouthParams {
                width: 0.55, upper_lip_thickness: 0.5, lower_lip_thickness: 0.55,
                corner_angle: 0.15, philtrum_depth: 0.5,
                lip_color: [0.85, 0.62, 0.62],
            },
            brows: BrowParams {
                thickness: 0.35, arch_height: 0.5, spacing: 0.5,
                angle: 0.1, color: [0.65, 0.55, 0.42],
            },
            skin: SkinParams {
                tone: [0.94, 0.87, 0.82], roughness: 0.45,
            ...
            hair: HairParams {
                ...
                length_scale: 1.0, volume: 0.6,
                part_position: 0.5, shininess: 0.5,
            },
            clothing: ClothingParams {
                preset: ClothingPreset::TankTop,
                color: [0.95, 0.95, 0.95],
                secondary_color: None, fit: 0.5,
            },
            body: BodyParams {
                height: 1.0, shoulder_width: 0.4,
                build: 0.3, neck_thickness: 0.35,
            },
        }
    }
}
