...
use kami_skeleton::{Skeleton, Bone};
use glam::Mat4;
...
pub fn generate_body(params: &BodyParams) -> MeshPart {
    ...
    for i in 0..=n_rings {
        ...
        for j in 0..=n_seg {
            ...
            vertices.push(Vertex { position: Vec3::new(x, y, z), normal: n, uv: [j as f32 / n_seg as f32, t] });
        }
    }
    ...
    MeshPart { name: "body".into(), vertices, indices, material: MaterialId::Skin }
}
...
pub fn generate_clothing(params: &ClothingParams, body: &BodyParams) -> MeshPart {
    ...
    for i in 0..=n_rings {
        ...
        let rx = if t < 0.5 { shoulder_w * t * 2.0 } else { shoulder_w + (t - 0.5) * 0.02 } + offset;
        ...
        for j in 0..=n_seg {
            ...
            let z = rz * theta.sin();
            let n = Vec3::new(theta.cos(), 0.0, theta.sin()).normalize();
            vertices.push(Vertex { position: Vec3::new(x, y, z), normal: n, uv: [j as f32 / n_seg as f32, i as f32 / n_rings as f32] });
        }
    }
    ...
    MeshPart { name: "clothing".into(), vertices, indices, material: MaterialId::Clothing }
}
