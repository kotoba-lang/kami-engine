// Blocky voxel pipeline: flat-shaded per-face color with N·L diffuse
// + distance fog. Input = pos3 + normal3 + rgb3 (36B/vertex). Each
// voxel face = 4 vertices, 2 triangles. Used by VoxelChunkAdapter in
// kami-pipelines.
...
fn fs(i: VsOut) -> @location(0) vec4<f32> {
    ...
    // Half-lambert softens horizontal faces under a low sun.
