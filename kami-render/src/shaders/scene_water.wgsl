// Minimal water plane shader — flat surface at y=water_level with
// time-driven ripple. Uniform carries view_proj, cam_pos, sun_dir,
// fog_color, time, water_color.
...
fn vs(i: VsIn) -> VsOut {
    var o: VsOut;
    // Ripple displacement: two crossing sinusoids.
    let k1 = 0.05;
    let k2 = 0.07;
    let a  = 0.15;
    let dy = a * (sin(i.pos.x * k1 + u.time * 1.3)
                + sin(i.pos.z * k2 + u.time * 0.9));
